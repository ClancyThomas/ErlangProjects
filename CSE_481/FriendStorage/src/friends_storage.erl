...
handle_cast(clear,Friends) -> 
         {noreply,[]}.%% modifying the server's internal state
...
handle_cast_test_()->
  [?_assertEqual({noreply,[sue,joe,sally]},friends_storage:handle_cast({add,sue},[joe,sally])),
  ?_assertEqual({noreply,[sue]},friends_storage:handle_cast({add,sue},[])),
  ...
  ?_assertEqual({noreply,[]},friends_storage:handle_cast(clear,[sue,joe,sally]))
  ].
